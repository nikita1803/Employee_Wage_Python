...
@Last Modified time: 2021-08-06 08:10:00
...
print("Total Working Hours of Employee according to the function" ,TOTAL_EMP_HR )
totalSalary = ( TOTAL_EMP_HR * EMP_RATE_PER_HR)
print("Total salary of workings hours" ,totalSalary)